                  ...
                  >
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="pt-4 border-t border-border">
                        ...
                        {/* Warning */}
                          <div className="mt-6 mb-4 p-4 bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 rounded-lg">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-red-700 dark:text-red-300">
                     Total cost projections are estimates only and may vary depending on market conditions. • Price updates every 30 seconds
                    </p>
                  </div>
                </div>
              </div>
