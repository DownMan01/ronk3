        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="bg-card/95 backdrop-blur-md shadow-xl">
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                <div className="mb-2 p-2 rounded-lg bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 text-red-800 dark:text-red-400 leading-7 text-sm">
                  ⚠️ The total network yield is not fixed and changes whenever farmers join or leave. Since it fluctuates
                  in real time, please enter the current total network yield manually below to ensure accurate
                  calculations.
                </div>
        ...
        <Card className="bg-card/95 backdrop-blur-md shadow-xl">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="p-3 rounded-lg bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 text-red-800 dark:text-red-400 text-sm">
                ⚠️ Earnings projections are estimates only and may vary depending on market conditions and network yield.
              </div>
